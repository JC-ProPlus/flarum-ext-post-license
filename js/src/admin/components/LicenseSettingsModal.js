...
const settingsPrefix = 'wvbforum-post-license.';
const translationPrefix = 'wvbforum-post-license.admin.settings.';
...
export default class LicenseSettingsModal extends SettingsModal {
    ...
    form() {
        ...
        return [
            ...
            m('.wvbforum__Post__Licenses', licenses.licenses.map(license => {
