...
export default class LicenseMeta extends Component {
    ...
    shortName() {
        if (!this.license) {
            return app.translator.trans('wvbforum-post-license.forum.license-meta.custom');
        }

        return app.translator.trans('wvbforum-post-license.forum.license-meta.label', {
    ...
    details() {
        if (!this.license) {
            return [
                m('p', m('em', app.translator.trans('wvbforum-post-license.forum.license-meta.custom-explanation'))),
        ...
        return [
            ...
            this.license.seeAlso.map(href => m('a', {
                ...
                rel: 'nofollow',
                target: '_blank',
            }, app.translator.trans('wvbforum-post-license.forum.license-meta.more'))),
        ];
    }
}
